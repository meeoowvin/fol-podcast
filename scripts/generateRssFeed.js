  ...
  <rss version="2.0"
    ...
    <channel>
      ...
      ${episodes
        ...
        <enclosure url="https://media.githubusercontent.com/media/meeoowvin/fol-podcast/master/episodes/${episode.slug}/${
            episode.audioUrl
          }" length="${
            fs.statSync(`${episodesDir}/${episode.slug}/episode.mp3`).size
          }" type="${episode.audioType}"/>
        <media:content type="${episode.audioType}" url="https://media.githubusercontent.com/media/meeoowvin/fol-podcast/master/episodes/${episode.slug}/${episode.audioUrl}"/>
        ...
        <guid isPermaLink="true">https://media.githubusercontent.com/media/meeoowvin/fol-podcast/master/episodes/${episode.slug}/${
            episode.audioUrl
          }</guid>
