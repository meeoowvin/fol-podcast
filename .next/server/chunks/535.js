...
function PlayButton({ player , size ="large"  }) {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", {
        type: "button",
        className: clsx__WEBPACK_IMPORTED_MODULE_1___default()("group relative flex flex-shrink-0 items-center justify-center rounded-full bg-cyan-700 hover:bg-cyan-900 focus:outline-none focus:ring-slate-700", {
